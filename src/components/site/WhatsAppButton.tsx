 ...
 * Mounts after `window.load` (or 1500 ms fallback) so it never competes with
 * the hero paint / first interactive on the main thread.
 */
export function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    let mounted = true;
    const reveal = () => mounted && setReady(true);
