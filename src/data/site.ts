...
export const PRODUCTS: Product[] = [
  {
    ...
    tagline: "Alta performance no preparo de alimentos em larga escala.",
    description:
      "Processador profissional projetado para cozinhas que exigem velocidade, precisão e durabilidade no pré-preparo diário.",
    longDescription:
      "O PA7 Pro Skymsen entrega capacidade de processamento contínuo com motor robusto e construção em aço inox. Ideal para cortar, ralar, fatiar e desfiar grandes volumes de hortifrúti, queijos e proteínas com uniformidade e segurança operacional.",
    image: pa7,
    highlight: true,
    detailed: true,
    specs: [
      { label: "Capacidade", value: "Até 250 kg/h" },
      { label: "Motor", value: "0,5 CV monofásico" },
      { label: "Discos inclusos", value: "07 unidades" },
      { label: "Material", value: "Aço inox AISI 304" },
      { label: "Tensão", value: "127 V / 220 V" },
      { label: "Garantia", value: "12 meses" },
    ],
    applications: [
      "Restaurantes com produção contínua",
      "Cozinhas industriais e refeitórios",
      "Redes e franquias com padronização de pré-preparo",
    ],
    compliance: [
      "Construção em conformidade com NR-12",
      "Materiais aprovados para contato com alimentos (RDC 91)",
      "Sistema de segurança com chave geral e proteção do disco",
    ],
  },
  {
